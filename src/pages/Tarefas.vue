<template>
  <q-page padding>
    ...
    <SemTarefas
      v-if="
        !Object.keys(tarefasHoje).length > 0 &&
          !Object.keys(proximasTarefas).length > 0 &&
          !Object.keys(tarefasPendentes).length > 0 &&
          !Object.keys(tarefasFinalizadas).length > 0
      "
    />
    ...
    <TodasTarefas
      ...
      rotulo="Outras"
      v-if="
        visao === 'todas' && Object.keys(tarefasPendentesInicial).length > 0
      "
    />
    ...
    <TodasTarefas
      ...
      rotulo="Finalizadas"
      v-if="
        visao === 'finalizadas' && Object.keys(tarefasFinalizadas).length > 0
      "
    />
    <TodasTarefas
