<template>
  <div
    :class="
      miniPainel
        ? 'menu_usuario absolute-bottom q-mb-md'
        : 'menu_usuario absolute-top'
    "
  >
    <div v-if="!miniPainel">
      ...
      <q-item clickable v-ripple>
        ...
        <q-menu :offset="[-85, -45]">
          <div class="row no-wrap q-pa-md">
            <div class="column">
              <div class="text-h7 text-center text-weight-bold q-mb-md">
                Ações
              </div>
              <q-btn
                class="q-mb-sm"
            ...
            <div class="column items-center">
              ...
              <div class="text-h7 text-weight-bold q-mt-md q-mb-xs">
                Diego Moraes
              </div>
            </div>
          </div>
